Git 命令总结
![](http://upload-images.jianshu.io/upload_images/6719885-f8c67f2a5946e3dc.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
基本命令
```
# 安装Git
...
$ git remote add origin git@github.com:mhy-web/demo.git 
$ git push -u origin master
